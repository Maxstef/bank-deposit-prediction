...
📚 Original data comes from the UCI Machine Learning Repository
...
* 🧠 Analyse model feature importance, predictions, and mistakes
...
├── data/
│   ├── raw/                 # 🗂️ Original dataset (never modify)
│   └── processed/           # ⚙️ Cleaned / feature-engineered data
│
├── notebooks/               # 📓 Exploration, modeling, experiments
│   ├── 01_eda.ipynb
│   └── 02_modeling.ipynb
│   └── ...
│
...
* 🥇 Random Forest achieved highest F1 but shows signs of overfitting
* ⚡ XGBoost provides best balance between performance and generalization
* 📉 Logistic Regression remains stable but less expressive for complex patterns
...
### ⚖️ Class imbalance findings

* ❌ Resampling did not improve results
...
### ⚠️ Error patterns & business view

* Errors come from **combined weak signals**, not single features
